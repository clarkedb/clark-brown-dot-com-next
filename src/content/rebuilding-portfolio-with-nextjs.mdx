...
1. A Gatsby site (<a href="https://clark-brown.firebaseapp.com/" target="_blank">demo</a> and <a href="https://github.com/clarkedb/clark-brown-dot-com-gatsby" target="_blank">source</a>)
1. This site here! (<a href="#">demo</a> and <a href="https://github.com/clarkedb/clark-brown-dot-com-next" target="_blank">source</a>)

### Dependency hell

I use GitHub's Dependabot to keep my dependencies up to date especially when their are security issues (which Next.js has had multiple critical <a href="https://nextjs.org/blog/CVE-2025-66478" target="_blank">CVEs</a> during development of this site). Because this took 2 years, Dependabot opened a lot of pull requests. I'm in awe at how the javascript world is built on dependencies on dependencies on dependencies. It's dependencies all the way down.
