...
Grift has 100% code coverage (line and branch) and is <a href="https://clarkedb.github.io/grift/" target="_blank">100% documented</a>.

See it on GitHub <a href="https://github.com/clarkedb/grift" target="_blank">here</a>.
...
Grift is already in use at <a href="https://neighbor.com" target="_blank">Neighbor</a> providing a pool of developers to learn from. Grift is open source though, so anyone can use it in their project.
