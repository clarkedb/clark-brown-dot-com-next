    ...
    <section className="prose prose-neutral dark:prose-invert">
      ...
      <section>
        ...
        <p>
          ...
          : Talk about edit distance algorithms and some of their use cases in software. Covers some
          of the common algorithms and the tradeoffs between different distances. (
          <a
