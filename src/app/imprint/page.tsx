export default function Privacy() {
  return (
    <main className="flex w-full flex-col gap-4">
      <h1 className="text-3xl font-medium tracking-tighter">Imprint</h1>
      <section className="flex flex-col gap-2">
        <h2 className="text-2xl">Information pursuant to § 5 TMG</h2>
        <p>
          CLARK BROWN
          <br />
          PLEASANT GROVE, UTAH
        ...
        <p>
          E-Mail Address:{' '}
          <a href="mailto:clark@clark-brown.com" className="hover:underline">
            CLARK@CLARK-BROWN.COM
          </a>
        </p>
      </section>
      <section className="flex flex-col gap-2">
        <h2 className="text-2xl">Liability for Contents</h2>
        <p>
          As service providers, we are liable for own contents of these websites according to Sec.
          7, paragraph 1 German Telemedia Act (TMG). However, according to Sec. 8 to 10 German
          Telemedia Act (TMG), service providers are not obligated to permanently monitor submitted
      ...
      <section className="flex flex-col gap-2">
        <h2 className="text-2xl">Liability for Links</h2>
        <p>
      ...
      <section className="flex flex-col gap-2">
        <h2 className="text-2xl">Copyright</h2>
        <p>
          ...
          originator. Downloads and copies of these websites are permitted for private use only. The
          commercial use of our contents without permission of the originator is prohibited.
        </p>
        <p>
